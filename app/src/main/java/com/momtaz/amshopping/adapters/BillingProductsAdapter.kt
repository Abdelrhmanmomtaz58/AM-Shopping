package com.momtaz.amshopping.adapters
...
import com.momtaz.amshopping.databinding.BillingProductsRvItemBinding
    ...
    inner class BillingProductsViewHolder(val binding: BillingProductsRvItemBinding): ViewHolder(binding.root) {
        ...
        fun bind(billingProduct: CartProduct) {
            binding.apply {
                ...
                tvProductCartPrice.text = "EGP ${String.format("%.2f", priceAfterPercentage)}"
